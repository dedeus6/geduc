...
public class Errors {
    ...
    public static final String EVENT_NUMER_IS_REQUIRED = "Event number is required";
    ...
    public static final String USER_ALREADY_SUBSCRIBE = "User already subscribe in this event";
}
